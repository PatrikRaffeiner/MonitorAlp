...
class TextReadOut(ABC):
    ...
    def __init__(self):
        self.dictionary = { # ID : [EN  ,  DE]
                            ...
                            "meas_txt_meas" : ["Measurements", "Messungen"],
                            "meas_txt_measInfo" : ["Measurement Info", "Messungs Info"],
                            "meas_btn_add" : ["Add Measurement", "Messung Hinzufügen"],
                            "meas_btn_calc" : ["Calc Displacement", "Verschiebung Berechnen"],
                            "meas_btn_del" : ["Delete Measurement", "Messung Löschen"],
