...
class TextReadOut(ABC):
    ...
    def __init__(self):
        self.dictionary = { # ID : [EN  ,  DE]
            ...
            "meas_menu_propsM" : ["!Show Measurement Properties::editMeasProps", "!Messungseinstellungen anzeigen::editMeasProps"],
            ...
            "meas_txt_partly_cloudy" : ["Partly cloudy", "Teilwese bewölkt"],
            ...
            "pdf_txt_absShift" : ["Absolute displacement \n (mm)", "Absolute Verschiebung \n (mm)"],
            "pdf_txt_titleD" : ["Drone measurement from <br/> ","Drohnen-Messung vom <br/> "],
            "pdf_txt_titleM" : ["Manual measurement from <br/> ","Manuelle Messung vom <br/> "],
